...
%-----------SelfCharcterisitc--------
\section{О себе}
    Меня можно характеризовать как ответственного и трудолюбивого человека. Я люблю программирование и занимаюсь им со средней школы. В 10-11 классе я посещал курсы по web-разработке, изучал JS, jQuery. После школы я активно самостоятельно изучал JS: читал техническую литературу, проходил как бесплатные, так и платные курсы и писал проекты. Учитывая школьный и вузовский опыт, можно сказать что я неплохо знаю алгоритмы и структуры данных. Так же изучаю и другие ЯП: C, C++, python. Не боюсь учиться новому, готов изучать новые технологии и применять их в проектах.
...
\section{Soft Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Обучаемость, адаптивность, знание Англиского языка(на уровне чтения документации), работа в команде}
    }
 \resumeSubHeadingListEnd
