...
%-----------SelfCharcterisitc--------
\section{О себе}
    Меня можно характеризовать как ответственного и трудолюбивого человека. Я люблю программирование и занимаюсь им со средней школы. В 10-11 классе посещал курсы по web-разработке, изучал JS, jQuery. После школы активно самостоятельно изучал JS: читал техническую литературу, проходил как бесплатные, так и платные курсы и писал проекты. В данный момент прохожу обучение в школе программистов HeadHunter по направленю frontend разработка. Учитывая школьный и вузовский опыт, можно сказать что я хорошо знаю алгоритмы и структуры данных. Так же изучаю и другие ЯП: C, C++, python. Готов учиться новому, изучать новые технологии и применять их в проектах.
